...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    */
    webpack: {
      compile_client: {
        devtool: 'source-map', entry: ['./asset/js'],
        output: {
          path: path.resolve(__dirname, 'dist/asset/js'), filename: 'app.js'
        },
    ...
    */
    ...
    copy: {
      client_static: {
        ...
        */
        ...
        files: [{ expand: true, cwd: "./asset", src: ["**", "!**/js/**"], dest: "./dist/asset" }]
      },
      server_template: {
    ...
    watch: {      
      ...
      */
      server_ts: {
        files: ["./server/**/*.ts", "common/**/*.ts", "!asset/js/**/*.ts"],
        tasks: ["ts"]
      },
      /*  
